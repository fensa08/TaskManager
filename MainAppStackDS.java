...
public class MainAppStackDS {
    ...
    public static StackDS<Task> readTasks() throws IOException {

        StackDS<Task> stackDS = new StackDS<>();
    ...
    public static StackDS<Task> generateFiveRandomTasks() throws IOException {
        StackDS<Task> stackDS = new StackDS<>();
